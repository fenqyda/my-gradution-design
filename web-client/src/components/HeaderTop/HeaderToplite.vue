...
.header_navlite > ul > li:first-child {
  font-size: 14px;
  line-height: 20px;
  cursor: pointer;
}
.header_navlite > ul > li > a {
...
.header_navlite > ul > li > a:hover {
  color: #999;
}
.header_navlite > ul > li:first-child > a:nth-child(2) {
  padding-left: 0;
  color: red;
}
</style>
