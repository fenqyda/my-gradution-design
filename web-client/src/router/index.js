...
const Send = ()=> import('./../pages/Me/Children/send');
const Sended = ()=> import('./../pages/Me/Children/sended');
...
const AdminComments = ()=> import('./../pages/Admin/Children/AdminComments');
...
export default  new VueRouter({
  ...
  routes: [
	...
	},
	{
	  ...
	  component: Search,
	  meta: {showHeaderToplite: true, showHeaderSearch: true}
  },
  {
	  path: '/goods/:id',
	  component: Goods,
	  meta: {showHeaderToplite: true}
  },
  {
	  path: '/me',
    component: Me,
  ...
  },
  {
    ...
    component: SearchDetail,
	  meta: {showHeaderTop: true, showHeaderSearchlite: true}
  },
	{
	  path: '/',
	  redirect: '/home'
