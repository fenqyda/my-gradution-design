    ...
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <ul class="navbar-nav px-3">
        <!-- <li class="nav-item text-nowrap">
          <router-link class="nav-link" @click="logout" to="/home" >返回餐厅</router-link>
        </li> -->
        <li class="nav-item text-nowrap">
          ...
          <div class="sidebar-sticky">
            ...
            <el-menu default-active="1" class="el-menu-vertical-demo">
              <el-menu-item index="1" @click="goTo('/admin/admingoods')">
                ...
                <span slot="title">餐品信息</span>
              </el-menu-item>
              <el-menu-item index="2" @click="goTo('/admin/addgoods')">
                <i class="el-icon-edit"></i>
                <span slot="title">餐品上架</span>
              </el-menu-item>
              ...
              <el-menu-item index="5" @click="goTo('/admin/admincomments')">
                <i class="el-icon-collection-tag"></i>
                <span>评论管理</span>
              </el-menu-item>
            </el-menu>
